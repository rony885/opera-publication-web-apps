                ...
                <table className="table align-middle mb-0 table-hover table-centered">
                  ...
                  <thead className="table-light">
                    <tr>
                      ...
                      <th className="text-center">Image One</th>
                      <th className="text-center">Image Two</th>
